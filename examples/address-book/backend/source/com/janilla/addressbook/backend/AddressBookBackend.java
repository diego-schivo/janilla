...
public class AddressBookBackend extends BlankBackend<AddressBookBackendConfig, AddressBookDomain> {

	private static final Logger LOGGER = System.getLogger(AddressBookBackend.class.getName());

	public static Stream<Class<?>> diTypes() {
		return Stream.of(BlankBackend.diTypes(), Java.getPackageTypes("com.janilla.addressbook"),
	...
	public static void main(String[] args) {
		...
		var cfg = newConfig(new Class<?>[] { AddressBookBackend.class }, args.length != 0 ? args[0] : null, f);
	...
	public AddressBookBackend(AddressBookBackendConfig config, DiFactory diFactory, Consumer<Object> context) {
