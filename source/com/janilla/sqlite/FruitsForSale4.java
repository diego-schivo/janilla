	...
	public static void main(String[] args) {
		...
		try (var ch = new TransactionalByteChannel(
			...
			d.perform(() -> {
				...
				var i = d.createIndex("Idx4", "fruitsforsale", "fruit", "state", "price");

				t.insert(_ -> new Object[] { 1l, "Orange", "FL", 0.85 });
				i.insert(new Object[] { "Orange", "FL", 0.85, 1l });
				t.insert(_ -> new Object[] { 2l, "Apple", "NC", 0.45 });
				i.insert(new Object[] { "Apple", "NC", 0.45, 2l });
				t.insert(_ -> new Object[] { 4l, "Peach", "SC", 0.60 });
				i.insert(new Object[] { "Peach", "SC", 0.60, 4l });
				t.insert(_ -> new Object[] { 5l, "Grape", "CA", 0.80 });
				i.insert(new Object[] { "Grape", "CA", 0.80, 5l });
				t.insert(_ -> new Object[] { 18l, "Lemon", "FL", 1.25 });
				i.insert(new Object[] { "Lemon", "FL", 1.25, 18l });
				t.insert(_ -> new Object[] { 19l, "Strawberry", "NC", 2.45 });
				i.insert(new Object[] { "Strawberry", "NC", 2.45, 19l });
				t.insert(_ -> new Object[] { 23l, "Orange", "CA", 1.05 });
				i.insert(new Object[] { "Orange", "CA", 1.05, 23l });

				IO.println(Arrays.toString(i.select("Orange", "CA").mapToDouble(x -> (double) x[2]).toArray()));

				IO.println(Arrays.toString(i.select("Peach").mapToDouble(x -> (double) x[2]).toArray()));
