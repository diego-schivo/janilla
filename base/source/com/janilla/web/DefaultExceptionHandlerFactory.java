...
public class DefaultExceptionHandlerFactory extends AbstractHttpHandlerFactory implements ExceptionHandlerFactory {

	public DefaultExceptionHandlerFactory(WebAppConfig config, HttpHandlerFactory rootFactory, DiFactory diFactory) {
		super(config, rootFactory, diFactory);
	}

	@Override
	public HttpHandler newHandler(Object input) {
		if (input instanceof Exception e) {
